...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadLegalEntities: function loadLegalEntities() {
      var _this = this;

      // load API
      axios.get('/api/legalEntities').then(function (response) {
        // assign this.legalEntities
        _this.legalEntities = response.data.data;
    ...
    loadPositions: function loadPositions() {
      ...
      axios.get('/api/positions').then(function (response) {
        // assign this.legalEntities
        _this2.positions = response.data.data;
      })["catch"](function (error) {
        // catch errors
        console.log(error);
      });
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('front-page', (__webpack_require__(/*! ./components/Front.vue */ "./resources/js/components/Front.vue")["default"]));
...
var render = function () {
  ...
  return _c("div", { staticClass: "form-group" }, [
    _c("label", [_vm._v("Odaberi firmu:")]),
    _vm._v(" "),
    _c("div", { staticClass: "list-group" }, [
      _c(
        "select",
        _vm._l(_vm.legalEntities, function (legalEntity) {
          return _c("option", { key: legalEntity.id }, [
